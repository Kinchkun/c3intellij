...
public class C3DocgenRunConfigurationFactory extends ConfigurationFactory
{
    public C3DocgenRunConfigurationFactory(@NotNull ConfigurationType type)
    {
        super(type);
    }
    ...
    {
        return "C3DocgenRunConfiguration";
    }
    ...
    {
        return new C3CommandRunConfiguration(project, this, "C3 Docgen", "docgen");
    }
